...
opts = {
  ...
  fireworkSpawnTime: 500, // Daha sık
  fireworkBaseReachTime: 70, // Daha hızlı çıkış
  ...
  fireworkCircleFadeAddedTime: 20,
  fireworkBaseShards: 5,
  fireworkAddedShards: 5,
  fireworkShardPrevPoints: 3,
  fireworkShardBaseVel: 2.2, // Daha hızlı parçacıklar
  fireworkShardAddedVel: 1.2,
  fireworkShardBaseSize: 3,
  fireworkShardAddedSize: 3,
  gravity: 0.05,
  upFlow: -0.05,
  letterContemplatingWaitTime: 600, // Daha kısa bekleme
  balloonSpawnTime: 80,
  balloonBaseInflateTime: 30,
  balloonAddedInflateTime: 30,
  balloonBaseSize: 20,
  balloonAddedSize: 20,
  balloonBaseVel: 0.2, // Balonlar daha hızlı
  balloonAddedVel: 0.2,
